  ...
  <div class="location-center-content">
    ...
    <div class="location-card">
      <div class="location-input-group">
        <input class="location-input" type="text" placeholder="Enter a location" bind:value={locationInput} on:keydown={handleKeyDown}/>
        <button on:click={lookupLocation} class="search-btn" aria-label="Search">
      ...
      <a class="current-location-link" on:click={geoFindMe}>Use my current location</a>
